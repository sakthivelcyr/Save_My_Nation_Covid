...
class SupportUs extends StatefulWidget {
  @override
  _SupportUs createState() => _SupportUs();
}

class _SupportUs extends State<SupportUs> {
  ...
  String name, district, mobnum, comments, add, area, state;
  ...
  Future<http.Response> postRequest() async {
    ...
    var sendResponse = await http.post(
        'https://tailermade.com/savemynation/api/v1/savemynation/supportus',
        headers: {"Content-Type": "application/x-www-form-urlencoded"},
        body: data,
        encoding: Encoding.getByName("gzip"));
    //var reBody = json.decode(response.body)['district'];
