...
class _Volunteer extends State<Volunteer> {
  ...
  String _dropDownDistrictValue,
      _dropDownStateValue,
      _dropDownProfessionalValue,
      _dropDownAreaValue;
  String name, district, mobnum, comments, add, area, state, professional;
  ...
  Future<http.Response> postRequest() async {
    ...
    var sendResponse = await http.post(
        'https://tailermade.com/savemynation/api/v1/savemynation/volunteer',
        headers: {"Content-Type": "application/x-www-form-urlencoded"},
        body: data,
        encoding: Encoding.getByName("gzip"));
    //var reBody = json.decode(response.body)['district'];
              ...
              onChanged: (val) {
                setState(
                  () {
                    ...
                    if (i == 3) {
                      _dropDownProfessionalValue = val;
                      professional = val;
                    }
                    if (i == 4) {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                ...
                headPadding('Intended Area of Contribution', wt),
                getdrop(
                    ...
                    RaisedButton(
                      onPressed: () {
                        setState(() {
                          ...
                          if (_dropDownProfessionalValue == null) {
                            errS = 'Please select your professional';
                            i = 1;
                          }
                          if (_dropDownAreaValue == null) {
                            errS = 'Please select your contribution';
                            i = 1;
                          }
                          if (i == 0) {
                            postRequest();
